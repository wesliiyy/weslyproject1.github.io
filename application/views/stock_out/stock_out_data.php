<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="#">Mutasi Out</a></div>
                        ...
                        <div class="card-header-form">
                            <form>
                                <div class="d-flex justify-content-end">
                                    <a class="btn btn-sm btn-primary" href="<?= site_url('stock/out/add'); ?>"><i class="fas fa-plus-circle"></i> Tambah Stock Out</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    foreach ($row as $key => $data) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= site_url('stock/out/del/' . $data->stock_id . '/' . $data->material_id) ?>" class="btn btn-danger btn-sm" id="btn-hapus"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                            </form>
                                            </td>
                                        </tr>
